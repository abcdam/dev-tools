...
import { isNotNullish } from "@util/guards/index";
import type { GuardFn, NeverNullOrUndefined } from "@util/guards/types";
...
export function check(input: any, ...predicates: any[]): any {
