...
import type { GuardFn } from "@util/guards/types";
...
): (input: V) => Option<R1 | R2 | R3 | R4 | R5 | R6>;
...
): (input: V) => Option<R1 | R2 | R3 | R4 | R5 | R6 | R7>;
...
): (input: V) => Option<R1 | R2 | R3 | R4 | R5 | R6 | R7 | R8>;
